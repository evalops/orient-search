...
`src/lib.rs:42:9`, copied `src/lib.rs:42: text` lines, and common stack-frame
forms like `at fn (src/lib.rs:42:9)` resolve to the file and anchor snippets
near that line. Absolute pasted paths are normalized when they are inside the
