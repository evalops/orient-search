...
pyproject scripts; `package:name` can jump to Cargo packages, pyproject
packages, and Go module paths; `bin:name`, `example:name`, and `bench:name` can
jump to Cargo manifest entries. See
