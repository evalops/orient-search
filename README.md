...
- `orient bench-search --repo /Users/jonathanhaas/Documents/Projects "session token auth"`: `26.294ms` p95 after warmup.
- `orient bench-search --repo /Users/jonathanhaas/Documents/Projects "browser session implementation"`: `19.928ms` p95 after warmup.
- `orient bench-search --repo /Users/jonathanhaas/Documents/Projects "postgres migration user"`: `37.192ms` p95 after warmup.
...
- `orient bench-search --repo . --index /tmp/orient-self.index "indexed search symbol filters"`: `0.860ms` p95 after warmup.
