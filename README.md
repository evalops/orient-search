...
Filters: `repo:`, `path:`/`dir:`, `file:`, `lang:`, `ext:`, `symbol:`, `kind:`/`type:`, `dep:`, `import:`, `test:`, `is:test`, `is:source`, `content:`, `text:`, `-path:docs`, quoted phrases. `file:` and `path:` accept `*` and `?` wildcards; `path:` accepts `/` or `\` separators.
