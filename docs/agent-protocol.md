...
Justfile targets, and GitHub Actions jobs, `script` / `package-script` for package.json and pyproject scripts,
...
`service` for Docker Compose services, and `bin` / `example` / `bench` for
