...
Bare pasted locations such as `src/lib.rs:42` and `src/lib.rs:42:9` strip the
line/column suffix for matching and anchor the returned snippet near the line.
