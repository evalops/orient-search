...
- Agent-oriented query language for `file:`, `path:`/`dir:`, `lang:`, `ext:`, `symbol:`, `repo:`, dependency filters via `dep:`/`dependency:`, import/module filters, `test:`, filter-only discovery queries, separator-normalized exact quoted phrases, negative filters, and default multi-term AND behavior.
