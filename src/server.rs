...
pub fn agent_guide(
    ...
    json!({
        ...
        "adapter_notes": [
            ...
            "Orient shares code-search artifacts only; it does not store prompts, transcripts, memories, or tool history.",
...
Orient is local code search only and does not collect telemetry, prompts, transcripts, memories, or tool history.",
        instruction_target = profile.instruction_target
    )
}
